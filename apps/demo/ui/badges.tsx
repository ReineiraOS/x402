...
> = {
  ...
  verified: {
    label: "Verified",
    dot: "var(--st-live)",
    color: "var(--st-live-text)",
    bg: "rgba(36,196,116,.08)",
    border: "rgba(36,196,116,.25)",
  },
  listed: {
    label: "Listed",
    dot: "var(--st-spec)",
    color: "var(--st-spec-text)",
    bg: "rgba(243,166,40,.08)",
    border: "rgba(243,166,40,.22)",
  },
};
...
> = {
  ...
  research: {
    label: "Research",
    dot: "var(--st-research)",
    color: "var(--st-research-text)",
    bg: "rgba(160,110,220,.10)",
  },
};
...
export function ConformanceChip({ state }: { state: Conformance }) {
  if (state === "pass") {
    return (
      <span
        ...
        style={{
          color: "var(--st-live-text)",
          background: "rgba(36,196,116,.08)",
          borderColor: "rgba(36,196,116,.22)",
        }}
        title="RSS v1 conformance suite passed"
      >
  ...
  if (state === "pending") {
    return (
      <span
        className="pill"
        style={{ color: "var(--st-spec-text)", background: "rgba(243,166,40,.08)" }}
        title="No conformance suite run published yet"
      >
        pending
      </span>
    );
  ...
  return (
    <span
      ...
      title="Conformance not applicable"
    >
      n/a
    </span>
  );
