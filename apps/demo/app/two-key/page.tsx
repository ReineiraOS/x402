...
export const metadata: Metadata = {
  ...
  description:
    "A security primitive on x402 rails — a Sentinel stakes a bond to raise an alarm, a Guardian freezes the vault, and a trustless on-chain verdict settles the stake.",
};
      ...
      <div className="page__head">
        <div>
          ...
          <p className="page__lead">
            ...
            freezes the vault, and a trustless on-chain verdict settles the stake.
          </p>
        </div>
      </div>
