      ...
      <div className="page__head">
        <div>
          ...
          <p className="page__lead">
            Each agent pays x402 resources from your passkey treasury. Funds settle into Escrow and
            release only when a Gate&apos;s condition is met. Create one, authorize a budget, and
            watch it settle on-chain.
          </p>
        </div>
      </div>
