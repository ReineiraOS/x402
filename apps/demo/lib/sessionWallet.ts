...
const PROJECT_ID = process.env.ZERODEV_PROJECT_ID ?? "866d15a6-e621-4e6a-b796-634611f34211";
...
// after is gasless.
const ZERODEV_RPC = `https://rpc.zerodev.app/api/v3/${PROJECT_ID}/chain/${ARBITRUM_SEPOLIA.chainId}`;
