...
function bundledCatalog(): PluginManifest[] {
  ...
  return [
    ...
    },
    {
      ...
      description:
        "Optional Insurance attached to the Escrow. If the seller misses the deadline, the buyer claims a payout from an underwriter pool.",
      resolverData: {
    ...
    },
    {
      ...
      interface: "IConditionResolver",
      description:
        "An attester confirms delivery before the deadline; release needs that attestation. A miss feeds the breach to the Insurance policy.",
      resolverData: {
